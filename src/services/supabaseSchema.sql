-- ==============================================================================
-- SAVOR — SUPABASE POSTGRESQL SCHEMA & ROW LEVEL SECURITY (RLS) POLICIES
-- ==============================================================================
...
-- 7. Recipe Cache Table (Live Gemini Responses)
...
-- 8. YouTube Cache Table (Live YouTube Data API v3 Responses)
